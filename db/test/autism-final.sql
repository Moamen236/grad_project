...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2021 at 11:56 PM
...
ALTER TABLE `autism_checker_question`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `autism_checker_id` (`autism_checker_id`);
...
ALTER TABLE `lovaas_question`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `category_id` (`lovaas_id`);
...
ALTER TABLE `patient`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `spcialist_id` (`spcialist_id`),
...
ALTER TABLE `scale_questions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `scale_category` (`scale_id`);
